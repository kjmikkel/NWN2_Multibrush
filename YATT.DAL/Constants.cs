...
namespace SFX.YATT.DAL
{
    class Constants
    {
        ...
        public static double VertexSpacing
        {
            get
            {
                return Constants._instance._vertexSpacing;
            }
        }
        private double _vertexSpacing;

        public static double TextureSpacing
        {
            get
            {
                return Constants._instance._textureSpacing;
            }
        }
        private double _textureSpacing;

        public static double MegaTileVertices
        {
            get
            {
                return Constants._instance._megaTileVertices;
            }
        }
        private double _megaTileVertices;

        private Constants()
        {
            this._vertexSpacing = 5.0/3.0;
            this._textureSpacing = 0.3125;
            this._megaTileVertices = 24;
        }
    }
}
